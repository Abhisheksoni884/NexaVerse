...
class Settings(BaseSettings):
    ...
    azure_openai_api_version: str = Field("2025-04-01-preview", alias="AZURE_OPENAI_API_VERSION")
    azure_openai_chat_deployment: str = Field("gpt-5", alias="AZURE_OPENAI_CHAT_DEPLOYMENT")
